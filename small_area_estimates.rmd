...
data <- read.table("gh_rdata.txt", header=TRUE, quote="\"", sep=",", dec = ".", stringsAsFactors=F) #saved input table
...
#add predicted values:
 ...
 geo_shell$PR_GEN_VGEXCL <- predict(
   gh_glm0, type = "response", newdata = gh_prediction, allow.new.levels = TRUE)
